                ...
                if get_or_create_params:
                    try:
                        obj = (await session.execute(
                            select(model_class).filter_by(**get_or_create_params))).scalars().one()
...
# https://github.com/kuzxnia/async_factory_boy/blob/master/async_factory_boy/factory/sqlalchemy.py
